...
@section('content')
    <div class="card">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form method="post" action="{{aurl('admin/destroy/all')}}" id="admins_form">
                <input type="hidden" name="_token" value="{{csrf_token()}}">
                <input type="hidden" name="_method" value="DELETE">
    {!! $dataTable->table([
        'class'=>'dataTable table table-striped table-hover table-responsive table-bordered','style'=>'width:100%'],true) !!}
        ...
        <div class="modal-dialog">
            <div class="modal-content" id="popupdelete">
                ...
                <div class="modal-body">
                   <h2> <strong class="msg" style="color:red;">You will Delete Selected Admins !</strong></h2>
                </div>
